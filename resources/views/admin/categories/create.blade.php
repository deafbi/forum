                    ...
                    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="space-y-1">
                            ...
                            <input
                                ...
                                type="text" id="tk-form-layouts-multiple-cards-username" name="name"
                                value="{{ old('name') }}" />
                        </div>
                        <div class="space-y-1">
                            ...
                            <input
                                class="block border border-gray-200 rounded px-3 py-2 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                type="text" id="tk-form-layouts-multiple-cards-name" name="icon"
                                value="{{ old('icon') }}" />
                        </div>
                        <div class="space-y-1">
                            ...
                            <select
                                class="block border border-gray-200 rounded px-3 py-2 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                id="tk-form-layouts-multiple-cards-name" name="tab">
                                @foreach ($categories as $category)
                                    <option value="{{ $category->name }}"
                                        {{ old('tab', $category->tab) == $category->name ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="space-y-1">
                            ...
                            <input
                                class="block border border-gray-200 rounded px-3 py-2 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                type="text" id="tk-form-layouts-multiple-cards-name" name="tab"
                                value="{{ old('tab') }}" />
                        </div>
                        <div class="space-y-1">
                            ...
                            <input
                                class="block border border-gray-200 rounded px-3 py-2 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                type="text" id="tk-form-layouts-multiple-cards-name" name="parent_id"
                                value="{{ old('tab') }}" />
                        </div>
                        <button type="submit"
