                    ...
                    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="space-y-1">
                            ...
                            <input
                                ...
                                type="text" id="tk-form-layouts-multiple-cards-username" placeholder="Shop" name="name"
                                value="{{ old('name') }}" />
                        </div>
                        <div class="space-y-1">
                            <label for="tk-form-layouts-multiple-cards-name" class="font-medium">Color</label>
                            <input
                                class="block border border-gray-200 rounded px-3 py-2 leading-6 w-full focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                type="text" id="tk-form-layouts-multiple-cards-name" placeholder="#ffffff" name="color"
                                value="{{ old('color') }}" />
                        </div>
                        <button type="submit"
