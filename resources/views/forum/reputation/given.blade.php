<x-app-layout>
    <div class="bg-[#242424] py-2 px-4 rounded-md mt-4 mb-4 text-gray-400 uppercase font-bold">
        <div class="flex space-x-2 items-center">
            ...
            @if ($user)
                ...
                <span class="text-neutral-400">Reputation given</span>
            @endif
        </div>
    </div>
    <div class="grid grid-cols-2 gap-4">
            ...
            <div class="bg-[#202020] rounded-md">
                <div class="px-4 py-2 text-neutral-500 font-bold">
                    <div class="flex justify-between mb-4">
                        <p>Positives</p>
                        <p>{{ $user->positiveReputationsGiven() }}</p>
                    </div>
                    <div class="flex justify-between mb-4">
                        <p> Negatives</p>
                        <p>{{ $user->negativeReputationsGiven() }}</p>
                    </div>
                    <div class="flex justify-between mb-4">
                        <p>Neutrals</p>
                        <p>{{ $user->neutralReputationsGiven() }}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex-row">
            <div class="bg-[#202020] rounded-md ">
                @forelse($reputationGivenData as $reputation)
                    <div class="flex items-center rounded-md py-5 px-5">
                        ...
                        <div class="flex-row ml-4">
                            <a href="#"
                                class="font-bold" style="color: {{ $reputation->giver->getUsernameColor() }};">{{ $reputation->giver->username }}
                                - <span
