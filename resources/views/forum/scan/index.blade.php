    ...
    <div class="bg-[#242424] py-2 px-4 rounded-md mt-4 mb-4 text-gray-400 uppercase font-bold">
        <div class="flex items-center space-x-2">
            ...
            @if ($user)
                ...
                <span class="text-neutral-400">Scan history</span>
            @endif
        </div>
    </div>
        <div class="flex-row">
            <div class="bg-[#202020] rounded-md ">
                @forelse($users as $reputation)
                    <div class="flex items-center py-5 rounded-md">
                        <div class="flex-row ml-4">
                            <a href="#"
                                class="font-bold" style="color: {{ $reputation->getUsernameColor() }};">{{ $reputation->username }}
                                - <span
